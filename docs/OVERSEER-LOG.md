...
Append-only. **Newest last.** This file is **not** read at boot: `docs/OVERSEER.md` is the
boot read and is bounded (protocol: *The boot read is bounded*). Reach for this file with
`tail`/`grep` when a particular night, a cited section, or a closed parcel is in question.

Everything below is the dated tail of `docs/OVERSEER.md` as of master `763966da`, moved
**verbatim** and re-ordered oldest-first by the date each entry carries; within one date the
original file order is preserved, so back-references like *"that section"* still resolve.
Each entry is preceded by a locator giving its original line span and the heading it sat
under; the date group is the first date the entry's own text carries. Any rule here
that is still live also stands in `docs/OVERSEER.md`.
...
*(original `docs/OVERSEER.md` lines 3310–3315, under: The autonomy directive — and its scope, which is the part that matters)*
...
*(original `docs/OVERSEER.md` lines 3644–3655, under: Quality bars)*
...
*(original `docs/OVERSEER.md` lines 4017–4030, under: The source-gate lane)*
...
*(original `docs/OVERSEER.md` lines 5007–5476, under: SIGIL-DECOUPLE — the owner ruled 2026-08-26, in this lane's session: follow aeon's plan)*
...
*(original `docs/OVERSEER.md` lines 5666–5683, under: Standing cross-session obligations (2026-08-22))*
...
*(original `docs/OVERSEER.md` lines 3498–3587, under: Quality bars)*
...
*(original `docs/OVERSEER.md` lines 3353–3365, under: Quality bars)*
...
*(original `docs/OVERSEER.md` lines 3486–3491, under: Quality bars)*
...
*(original `docs/OVERSEER.md` lines 3597–3602, under: Quality bars)*
...
*(original `docs/OVERSEER.md` lines 4892–4977, under: SIGIL-DECOUPLE — the owner ruled 2026-08-26, in this lane's session: follow aeon's plan)*
...
*(original `docs/OVERSEER.md` lines 5477–5522)*
...
*(original `docs/OVERSEER.md` lines 5523–5609)*
...
*(original `docs/OVERSEER.md` lines 5631–5635, under: Standing cross-session obligations (2026-08-22))*
...
*(original `docs/OVERSEER.md` lines 2715–2726)*
...
*(original `docs/OVERSEER.md` lines 3456–3457, under: Quality bars)*
...
*(original `docs/OVERSEER.md` lines 3690–3753)*
...
*(original `docs/OVERSEER.md` lines 3754–3781)*
...
*(original `docs/OVERSEER.md` lines 3782–3802)*
...
*(original `docs/OVERSEER.md` lines 3803–3822)*
...
*(original `docs/OVERSEER.md` lines 3823–3915)*
...
*(original `docs/OVERSEER.md` lines 4058–4126)*
...
*(original `docs/OVERSEER.md` lines 4127–4144)*
...
*(original `docs/OVERSEER.md` lines 4255–4323)*
...
*(original `docs/OVERSEER.md` lines 4324–4369)*
...
*(original `docs/OVERSEER.md` lines 4430–4449)*
...
*(original `docs/OVERSEER.md` lines 4450–4468)*
...
*(original `docs/OVERSEER.md` lines 4469–4484)*
...
*(original `docs/OVERSEER.md` lines 4513–4526)*
...
*(original `docs/OVERSEER.md` lines 4527–4542)*
...
*(original `docs/OVERSEER.md` lines 4597–4611)*
...
*(original `docs/OVERSEER.md` lines 4612–4689)*
...
*(original `docs/OVERSEER.md` lines 2699–2714)*
...
*(original `docs/OVERSEER.md` lines 1322–1339)*
...
*(original `docs/OVERSEER.md` lines 1741–1762)*
...
*(original `docs/OVERSEER.md` lines 1763–1770)*
...
*(original `docs/OVERSEER.md` lines 1771–1796)*
...
*(original `docs/OVERSEER.md` lines 1797–1833)*
...
*(original `docs/OVERSEER.md` lines 1834–1866)*
...
*(original `docs/OVERSEER.md` lines 1867–1883)*
...
*(original `docs/OVERSEER.md` lines 1884–1911)*
...
*(original `docs/OVERSEER.md` lines 2334–2352)*
...
*(original `docs/OVERSEER.md` lines 2353–2364)*
...
*(original `docs/OVERSEER.md` lines 2365–2385)*
...
*(original `docs/OVERSEER.md` lines 2386–2405)*
...
*(original `docs/OVERSEER.md` lines 2406–2420)*
...
*(original `docs/OVERSEER.md` lines 2421–2444)*
...
*(original `docs/OVERSEER.md` lines 2445–2469)*
...
*(original `docs/OVERSEER.md` lines 2470–2484)*
...
*(original `docs/OVERSEER.md` lines 2485–2498)*
...
*(original `docs/OVERSEER.md` lines 2499–2698)*
...
*(original `docs/OVERSEER.md` lines 2727–2761)*
...
*(original `docs/OVERSEER.md` lines 2762–2799)*
...
*(original `docs/OVERSEER.md` lines 2800–2821)*
...
*(original `docs/OVERSEER.md` lines 2822–2839)*
...
*(original `docs/OVERSEER.md` lines 2840–2886)*
...
*(original `docs/OVERSEER.md` lines 2887–2905)*
...
*(original `docs/OVERSEER.md` lines 2906–2935)*
...
*(original `docs/OVERSEER.md` lines 4690–4712)*
...
*(original `docs/OVERSEER.md` lines 4713–4735)*
...
*(original `docs/OVERSEER.md` lines 4776–4839, under: PROVENANCE-REV-REACHABILITY — LANDED. The ledger now judges the revisions it records)*
...
*(original `docs/OVERSEER.md` lines 5713–5741)*
...
*(original `docs/OVERSEER.md` lines 376–415)*
...
*(original `docs/OVERSEER.md` lines 416–533)*
...
*(original `docs/OVERSEER.md` lines 534–557)*
...
*(original `docs/OVERSEER.md` lines 558–573)*
...
*(original `docs/OVERSEER.md` lines 574–592)*
...
*(original `docs/OVERSEER.md` lines 593–609)*
...
*(original `docs/OVERSEER.md` lines 610–647)*
...
*(original `docs/OVERSEER.md` lines 648–675)*
...
*(original `docs/OVERSEER.md` lines 676–712)*
...
*(original `docs/OVERSEER.md` lines 713–725)*
...
*(original `docs/OVERSEER.md` lines 726–744)*
...
*(original `docs/OVERSEER.md` lines 745–766)*
...
*(original `docs/OVERSEER.md` lines 767–798)*
...
*(original `docs/OVERSEER.md` lines 799–825)*
...
*(original `docs/OVERSEER.md` lines 826–846)*
...
*(original `docs/OVERSEER.md` lines 847–870)*
...
*(original `docs/OVERSEER.md` lines 871–885)*
...
*(original `docs/OVERSEER.md` lines 886–923)*
...
*(original `docs/OVERSEER.md` lines 924–952)*
...
*(original `docs/OVERSEER.md` lines 953–981)*
...
*(original `docs/OVERSEER.md` lines 982–997)*
...
*(original `docs/OVERSEER.md` lines 998–1015)*
...
*(original `docs/OVERSEER.md` lines 1016–1034)*
...
*(original `docs/OVERSEER.md` lines 1035–1060)*
...
*(original `docs/OVERSEER.md` lines 1061–1087)*
...
*(original `docs/OVERSEER.md` lines 1088–1110)*
...
*(original `docs/OVERSEER.md` lines 1111–1182)*
...
*(original `docs/OVERSEER.md` lines 1183–1239)*
...
*(original `docs/OVERSEER.md` lines 1240–1254)*
...
*(original `docs/OVERSEER.md` lines 1255–1321)*
...
*(original `docs/OVERSEER.md` lines 1342–1378, under: Standing rules — independent of whether a row is active)*
...
*(original `docs/OVERSEER.md` lines 1386–1392, under: Standing rules — independent of whether a row is active)*
...
*(original `docs/OVERSEER.md` lines 1426–1473)*

### CHAIN 193 ATTESTED GREEN — verified here, with one correction to the peer's report

Read from `provenance.toml` rather than taken: entry **193** `vertical-bob-attested`, **4176 passed
/ 0 failed / 2 ignored**, 363 suites, `aeon_rev 25731dfa`. `refreeze --check` OK at chain len 193;
181's `strict.sigil_rev` still the only DIVERGENT, untouched.

**The aeon lane's report cited `sigil_rev cd157827`. The ledger records `06936bff`, and the LEDGER
is right.** `cd157827` is this lane's rename fix (10:26); `06936bff` is the freeze commit (10:43)
and was HEAD when the strict suite ran, so it is the tree the record is about. Confirmed REACHABLE
from `origin/master`. **Flagged because a provenance claim that disagrees with its own ledger is
exactly the defect this chain exists to prevent** — a later reader comparing the two would not know
which to believe, and the answer is always the file.

**THE LANDING'S SHAPE IS THE ARTIFACT WORTH KEEPING: three attempts, two red records, every refusal
correct.** A harness SIGTERM; 36 substituted binaries plus one real defect; a HEAD move; a field
rename. **Nothing false was ever written to the ledger.** Chains 190 and 192 stand red and
superseded rather than repaired — the guard working as designed, not a blemish on the run.
...
*(original `docs/OVERSEER.md` lines 1474–1740)*
...
The aeon lane predicted, before building, that re-freezing at `befbae65` would leave all four
canonical CRCs identical to chain 190's, on the grounds that the `2e976223 → befbae65` range was
docs, `.gitignore`, a comment-only `ojz_effects.emp` correction, and 34 newly-**tracked** editor
`.bin` files that are not build inputs. **HELD.** `36adb158`/719329, `eadd7175`/736331,
`9223a60d`/96450, `d30c3636`/101333, and the off-canonical set unchanged too (`3c510af9`,
`c10fa715`, `20554b7f`). Chain **191** `preset-sec5-split-attested`, sigil `b0704ac5`; **190
abandoned red**, not repaired.

**`refreeze: FIXPOINT PASSED` is a better result than four matching CRCs and the difference is worth
naming.** Four CRCs is *the seven numbers somebody chose to check*. The fixpoint says **the whole
regenerated golden set is byte-identical to the tip** — it quantifies over the set rather than over
a sample. When both are available, cite the fixpoint; a CRC list is a sample presented in the
grammar of a total.

**A PROPERTY OF `DONOR_PROVENANCE.json` THAT FORBIDS A GATE ON IT: IT CAN NEVER BE A FIXPOINT**
*(aeon's, and it binds this lane because this lane builds the gates).* The file **records the HEAD it
was baked at**, so committing a regenerated copy changes the head the *next* bake would record —
chase-your-tail **by construction**. **Do not write a "regenerate and compare" gate over it**; it
would go red on a correct tree forever, and the remedy would be hand-editing a baseline, which this
file already identifies as indistinguishable from hiding a defect. Related and equally load-bearing:
the field also records **bake-time dirtiness**, so a bake run in a working tree carrying uncommitted
files is **not canonical**. Aeon committed the copy produced in a clean detached worktree for exactly
that reason.

**Its real payload, which vindicates the art commit on an axis nobody argued:** the record moved from
`modified_tracked: 7` to `2`, because those bodies were **untracked and therefore invisible to the
SHA that claimed to identify the bake's inputs**. The bake was **not reproducible from its own
provenance record**. That is this file's *name-is-not-behaviour* defect wearing a provenance field:
a SHA that names a tree state it does not actually pin.

**AND THE STALENESS GATE THAT REFUSED IS mtime-BASED, WHICH IS WHY CHECKING OUT A COMMIT TRIPPED
IT.** `build.sh` compares *newest mtime(editor sources)* against *newest mtime(generated tree)*.
Tracking 17 backgrounds meant a checkout across that commit rewrote them with **checkout mtimes**,
so the editor side became newer and the build refused. **Nothing was wrong with the data** — aeon
ran the re-bake rather than assuming: one file changed, every generated byte identical. That is the
gate's own acknowledged **touched-but-unchanged** case, which it deliberately prefers to missing a
real edit. Correct behaviour; worth knowing before reading such a refusal as a defect.
...
*(original `docs/OVERSEER.md` lines 1912–1944)*
...
*(original `docs/OVERSEER.md` lines 1945–1957)*
...
*(original `docs/OVERSEER.md` lines 1958–1977)*
...
*(original `docs/OVERSEER.md` lines 1978–2001)*
...
*(original `docs/OVERSEER.md` lines 2002–2046)*
...
*(original `docs/OVERSEER.md` lines 2047–2076)*
...
*(original `docs/OVERSEER.md` lines 2077–2100)*
...
*(original `docs/OVERSEER.md` lines 2101–2122)*
...
*(original `docs/OVERSEER.md` lines 2123–2163)*
...
*(original `docs/OVERSEER.md` lines 2164–2207)*
...
*(original `docs/OVERSEER.md` lines 2208–2226)*
...
*(original `docs/OVERSEER.md` lines 2227–2252)*
...
*(original `docs/OVERSEER.md` lines 2253–2279)*
...
*(original `docs/OVERSEER.md` lines 2280–2303)*
...
*(original `docs/OVERSEER.md` lines 2304–2333)*
...
*(original `docs/OVERSEER.md` lines 2960–2981)*
...
*(original `docs/OVERSEER.md` lines 2982–3044)*
...
*(original `docs/OVERSEER.md` lines 3045–3140)*
...
*(original `docs/OVERSEER.md` lines 4145–4169)*
...
*(original `docs/OVERSEER.md` lines 4170–4183)*
...
*(original `docs/OVERSEER.md` lines 4184–4223)*
...
*(original `docs/OVERSEER.md` lines 4224–4254)*
...
*(original `docs/OVERSEER.md` lines 5742–5749)*
...
*(original `docs/OVERSEER.md` lines 5750–5775)*
...
*(original `docs/OVERSEER.md` lines 5776–5800)*
...
*(original `docs/OVERSEER.md` lines 5801–5838)*
...
*(original `docs/OVERSEER.md` lines 5839–5850)*
...
*(original `docs/OVERSEER.md` lines 5851–5885)*
...
*(original `docs/OVERSEER.md` lines 5886–5903)*
...
*(original `docs/OVERSEER.md` lines 5904–5922)*
...
*(original `docs/OVERSEER.md` lines 5923–5957)*
...
*(original `docs/OVERSEER.md` lines 5958–5997)*
...
*(original `docs/OVERSEER.md` lines 5998–6033)*
...
*(original `docs/OVERSEER.md` lines 6034–6077)*
...
*(original `docs/OVERSEER.md` lines 340–375, under: LANDED on `parcel/comptime-compare-refuses` — and one line of the brief above is wrong (2026-09-02))*
...
## 2026-09-04 cut — the re-baseline episode, moved verbatim from `docs/OVERSEER.md` (original lines 201-232)

Moved at 2026-09-04T08:25:01Z to make room in the bounded boot read for two owner authorizations. The RULE
survives in `OVERSEER.md` under the standing-rules section; the episode below is the narrative it
was earned from, unedited.
...
## 2026-09-04 cut — the chain-180 freeze-witness episode, moved verbatim from `docs/OVERSEER.md` (original lines 97-118)

Moved at 2026-09-04T08:26:00Z, same reason and same pass as the cut above. The RULE (prefer the positive
witness, and its two limits) survives in `OVERSEER.md`; the chain-180/181 narrative is below, unedited.
...
### also moved in the 2026-09-04 cut — the lifted-hold note (original lines 93-95)

Fully closed: the hold was lifted and the chain-181 re-arm it anticipated is long past (the chain
is near 198). Kept for the record; the live hold TABLE stays in `OVERSEER.md`.
...
### also moved in the 2026-09-04 cut — two paragraphs the head pointer-ised (verbatim)

Both were checked BEFORE being dropped and neither was held anywhere else: the protocol does not
carry the `cea2e57c`/`274d26d2` pair (grep count 0 at `origin/main`), and this log did not carry
the recovery-cycle sentence (grep count 0). The head now points HERE for both.

From the Boot section, the protocol-drift measurement that earned "re-read mid-session":
...
From the dispatch-practice section, the branch-deletion episode detail:
...
**The argument was wrong, and the flaw is exactly the bar `docs/OVERSEER.md` enforces on everyone
else:
...
is the former, re-baselining the test is the move `docs/OVERSEER.md` forbids twice over; the
expectations
...
**Closed by REGENERATING, never by hand**, which is the boot read's own standing ruling on generated
...
the same one `docs/OVERSEER.md` applies to everything else, aimed at the severity rather than the
