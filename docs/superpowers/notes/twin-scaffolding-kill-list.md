...
| 14 | Collision-block constants twin growth — `NUM_PLAYERS/DYNAMIC/SYSTEM/EFFECTS`, `COLLISION_TOUCH`, `ST_IN_AIR/ON_OBJECT/P1_STANDING` | `engine/system/constants.emp` (truth: `engine/constants.asm:140-197`) | 9 ensures (in row 1's block) | `constants.asm` ports → flip (row 1's condition). |
