...
. /home/volence/sonic_hacks/sigil/.claude/worktrees/agent-a08cead7e136bc593/docs/superpowers/notes/asl-reference/asl_ref.sh || exit $?
P2BIN=$ASLDIR/p2bin
N="$1"
cd "$S/probes" || exit 9
