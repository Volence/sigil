...
#
# Keep the out-dir OUTSIDE any cargo target directory and outside the sigil
# worktree: a second `tools/suite_paths.py` under either makes
# `scripts_name_their_tree` and the drift harness answer COULD NOT MEASURE.
set -uo pipefail
