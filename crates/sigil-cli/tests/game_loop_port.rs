...
//!   (plain `$5EDA`, debug `$7398`) — both `jbsr` -> `bsr.w` PC-RELATIVE, so
...
const PLAIN: Shape = Shape { base: 0x22FE, vsync_wait: 0x2262, drain: 0x5EDA };
const DEBUG: Shape = Shape { base: 0x238C, vsync_wait: 0x22EC, drain: 0x7398 };
