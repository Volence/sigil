...
/// SOUND-OFF (config_b, sonic4 game): the hole is LIVE. BootData @ $39a, the
...
fn config_b_boot_data_hole_filled() {
    ...
    // BootData ($39a) .. BootData_End ($3fe): head + idle-in-hole + tail, byte-exact.
    assert_window("config_b", &rom, &gold, 0x39a, 0x3fe);
