...
//!
//! [provenance] plain: /home/volence/sonic_hacks/aeon/s4.lst (07/16/2026 01:40:35 AM)
//! [provenance] debug: /home/volence/sonic_hacks/aeon/s4.debug.lst (07/16/2026 01:40:32 AM)
...
pub const TILE_CACHE: Region = Region { plain_base: 0x42FA, debug_base: 0x4EC4, plain_len: 0xB28, debug_len: 0xBE8 };

/// `Collision_GetType` .. `Collision_ProbeDown` — gate `SIGIL_EMP_COLLISION_LOOKUP`. tests: collision_lookup_port
pub const COLLISION_LOOKUP: Region = Region { plain_base: 0x4E22, debug_base: 0x5AAC, plain_len: 0x24, debug_len: 0x24 };

/// `Section_Init` .. `Camera_Init` — gate `SIGIL_EMP_SECTION`. tests: section_port
pub const SECTION: Region = Region { plain_base: 0x5342, debug_base: 0x5FCC, plain_len: 0x3DC, debug_len: 0x3DC };

/// `Sound_PostByte` .. start + 0x1E4 plain / 0x2DA debug (literal — no end symbol) — gate `SIGIL_EMP_SOUND_API`. tests: sound_api_port
pub const SOUND_API: Region = Region { plain_base: 0x5F8A, debug_base: 0x78AE, plain_len: 0x1E4, debug_len: 0x2DA };
...
pub const SOUND_DRAIN_SFX_RING: Pin = Pin { plain: 0x60D0, debug: 0x7AEA };
...
pub const SOUND_PLAY_RING: Pin = Pin { plain: 0x6120, debug: 0x7B3A };
...
pub const SOUND_PLAY_SFX: Pin = Pin { plain: 0x608A, debug: 0x7A5E };
...
pub const SECTION_GET_SEC_PTR_XY: Pin = Pin { plain: 0x5392, debug: 0x601C };

/// `Section_FlatIDXY`. tests: entity_window_port
pub const SECTION_FLAT_IDXY: Pin = Pin { plain: 0x5378, debug: 0x6002 };
