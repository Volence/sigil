...
pub const VBLANK: Region = Region { plain_base: 0x21A0, debug_base: 0x2224, plain_len: 0x164, debug_len: 0x16C };

/// `HBlank_Install` .. `Read_Controllers` — gate `SIGIL_EMP_HBLANK`. tests: hblank_port, m1c_vector_table
pub const HBLANK: Region = Region { plain_base: 0x2304, debug_base: 0x2390, plain_len: 0x48, debug_len: 0x48 };

/// `Read_Controllers` .. `GameLoop` — gate `SIGIL_EMP_CONTROLLERS`. tests: controllers_port
pub const CONTROLLERS: Region = Region { plain_base: 0x234C, debug_base: 0x23D8, plain_len: 0x76, debug_len: 0x78 };

/// `GameLoop` .. `S4LZ_DecompressDict` — gate `SIGIL_EMP_GAME_LOOP`. tests: game_loop_port, load_art_port
pub const GAME_LOOP: Region = Region { plain_base: 0x23C2, debug_base: 0x2450, plain_len: 0x12, debug_len: 0x12 };

/// `S4LZ_DecompressDict` .. `ZX0_Decompress` — gate `SIGIL_EMP_S4LZ`. tests: s4lz_port
pub const S4LZ: Region = Region { plain_base: 0x23D4, debug_base: 0x2462, plain_len: 0xF8, debug_len: 0x200 };

/// `ZX0_Decompress` .. `GetSineCosine` — gate `SIGIL_EMP_ZX0`. tests: zx0_port
pub const ZX0: Region = Region { plain_base: 0x24CC, debug_base: 0x2662, plain_len: 0x58, debug_len: 0x58 };

/// `GetSineCosine` .. `Perform_DPLC` — gate `SIGIL_EMP_MATH`. tests: math_port
pub const MATH: Region = Region { plain_base: 0x2524, debug_base: 0x26BA, plain_len: 0x298, debug_len: 0x298 };

/// `Perform_DPLC` .. `InitObjectRAM` — gate `SIGIL_EMP_DPLC`. tests: dplc_port
pub const DPLC: Region = Region { plain_base: 0x27BC, debug_base: 0x2952, plain_len: 0xA4, debug_len: 0xA4 };

/// `InitObjectRAM` .. `InitSpriteSystem` — gate `SIGIL_EMP_CORE`. tests: core_port
pub const CORE: Region = Region { plain_base: 0x2860, debug_base: 0x29F6, plain_len: 0x2E4, debug_len: 0x72C };

/// `InitSpriteSystem` .. `AnimateSprite` — gate `SIGIL_EMP_SPRITES`. tests: sprites_port
pub const SPRITES: Region = Region { plain_base: 0x2B44, debug_base: 0x3122, plain_len: 0x420, debug_len: 0x420 };

/// `AnimateSprite` .. `TouchResponse` — gate `SIGIL_EMP_ANIMATE`. tests: animate_port, test_objects_port
pub const ANIMATE: Region = Region { plain_base: 0x2F64, debug_base: 0x3542, plain_len: 0x18A, debug_len: 0x2A8 };

/// `TouchResponse` .. `RingBuffer_Add` — gate `SIGIL_EMP_COLLISION`. tests: collision_port
pub const COLLISION: Region = Region { plain_base: 0x30EE, debug_base: 0x37EA, plain_len: 0x200, debug_len: 0x208 };

/// `RingBuffer_Add` .. `Collected_Init` — gate `SIGIL_EMP_RINGS`. tests: rings_port
pub const RINGS: Region = Region { plain_base: 0x32EE, debug_base: 0x39F2, plain_len: 0x1B8, debug_len: 0x214 };

/// `Collected_Init` .. `PopulateSpawnedPieceCount` — gate `SIGIL_EMP_ENTITY_WINDOW`. tests: entity_window_port
pub const ENTITY_WINDOW: Region = Region { plain_base: 0x34A6, debug_base: 0x3C06, plain_len: 0x8FA, debug_len: 0xD62 };

/// `PopulateSpawnedPieceCount` .. `Load_Object` — gate `SIGIL_EMP_CHILDREN`. tests: children_port
pub const CHILDREN: Region = Region { plain_base: 0x3DA0, debug_base: 0x4968, plain_len: 0x2D0, debug_len: 0x3E8 };

/// `Load_Object` .. `Plane_Buffer_Reset` — gate `SIGIL_EMP_LOAD_OBJECT`. tests: load_object_port, entity_window_port
pub const LOAD_OBJECT: Region = Region { plain_base: 0x4070, debug_base: 0x4D50, plain_len: 0x82, debug_len: 0x82 };

/// `Plane_Buffer_Reset` .. `Tile_Cache_GetTile` — gate `SIGIL_EMP_PLANE_BUFFER`. tests: plane_buffer_port
pub const PLANE_BUFFER: Region = Region { plain_base: 0x40F2, debug_base: 0x4DD2, plain_len: 0x2FE, debug_len: 0x2FE };

/// `Tile_Cache_GetTile` .. `Collision_GetType` — gate `SIGIL_EMP_TILE_CACHE`. tests: tile_cache_port
pub const TILE_CACHE: Region = Region { plain_base: 0x43F0, debug_base: 0x50D0, plain_len: 0xCE0, debug_len: 0xDA0 };

/// `Collision_GetType` .. `Collision_ProbeDown` — gate `SIGIL_EMP_COLLISION_LOOKUP`. tests: collision_lookup_port
pub const COLLISION_LOOKUP: Region = Region { plain_base: 0x50D0, debug_base: 0x5E70, plain_len: 0x70, debug_len: 0x70 };

/// `Section_Init` .. `Camera_Init` — gate `SIGIL_EMP_SECTION`. tests: section_port
pub const SECTION: Region = Region { plain_base: 0x563C, debug_base: 0x63DC, plain_len: 0x424, debug_len: 0x424 };

/// `Camera_Init` .. `Parallax_Init` — gate `SIGIL_EMP_CAMERA`. tests: camera_port
pub const CAMERA: Region = Region { plain_base: 0x5A60, debug_base: 0x6800, plain_len: 0x168, debug_len: 0x168 };

/// `Parallax_Init` .. `Art_Decompress` — gate `SIGIL_EMP_PARALLAX`. tests: parallax_port
pub const PARALLAX: Region = Region { plain_base: 0x5BC8, debug_base: 0x6968, plain_len: 0x5D2, debug_len: 0x5D2 };

/// `Art_Decompress` .. `BG_Init` — gate `SIGIL_EMP_LOAD_ART`. tests: load_art_port
pub const LOAD_ART: Region = Region { plain_base: 0x619A, debug_base: 0x6F3A, plain_len: 0x64, debug_len: 0xB6 };

/// `BG_Init` .. `BgAnim_Init` — gate `SIGIL_EMP_BG`. tests: bg_port
pub const BG: Region = Region { plain_base: 0x61FE, debug_base: 0x6FF0, plain_len: 0xB2, debug_len: 0xAE };

/// `BgAnim_Init` .. start + 0x9E plain / 0x158 debug (literal — no end symbol) — gate `SIGIL_EMP_BG_ANIM`. tests: bg_anim_port
pub const BG_ANIM: Region = Region { plain_base: 0x62B0, debug_base: 0x709E, plain_len: 0x9E, debug_len: 0x158 };
...
pub const COMPRESSION_SELFTEST: Region = Region { plain_base: 0x634E, debug_base: 0x71F6, plain_len: 0x0, debug_len: 0xC8A };

/// `Sound_PostByte` .. start + 0x20A plain / 0x3B4 debug (literal — no end symbol) — gate `SIGIL_EMP_SOUND_API`. tests: sound_api_port
pub const SOUND_API: Region = Region { plain_base: 0x634E, debug_base: 0x7E80, plain_len: 0x20A, debug_len: 0x3B4 };
...
pub const PLAYER_SENSORS: Region = Region { plain_base: 0x5140, debug_base: 0x5EE0, plain_len: 0x4FC, debug_len: 0x4FC };
...
pub const CREATE_EFFECT_NORMAL: Pin = Pin { plain: 0x3FDA, debug: 0x4CAC };

/// `CreateChild_Normal`. tests: test_g3_objects_port
pub const CREATE_CHILD_NORMAL: Pin = Pin { plain: 0x3DC2, debug: 0x498A };

/// `DeleteChildren`. tests: test_g3_objects_port
pub const DELETE_CHILDREN: Pin = Pin { plain: 0x3FBC, debug: 0x4C8E };

/// `GetSineCosine`. tests: test_g3_objects_port
pub const GET_SINE_COSINE: Pin = Pin { plain: 0x2524, debug: 0x26BA };
...
pub const V_SYNC_WAIT: Pin = Pin { plain: 0x22E4, debug: 0x236C };

/// `Sound_DrainSfxRing`. tests: game_loop_port, load_art_port
pub const SOUND_DRAIN_SFX_RING: Pin = Pin { plain: 0x64BA, debug: 0x8196 };
...
pub const DRAW_TILE_COLUMN: Pin = Pin { plain: 0x40FA, debug: 0x4DDA };

/// `Draw_TileRow_FromCache`. tests: section_port
pub const DRAW_TILE_ROW_FROM_CACHE: Pin = Pin { plain: 0x422E, debug: 0x4F0E };

/// `EntityWindow_Init`. tests: section_port
pub const ENTITY_WINDOW_INIT: Pin = Pin { plain: 0x3864, debug: 0x4342 };
...
pub const PLANE_BUFFER_PTR: Pin = Pin { plain: 0xFFFFA726, debug: 0xFFFFA74A };

/// `Plane_Buffer`. tests: plane_buffer_port
pub const PLANE_BUFFER_BASE: Pin = Pin { plain: 0xFFFFA126, debug: 0xFFFFA14A };
...
pub const S4_LZ_DECOMPRESS_DICT: Pin = Pin { plain: 0x23D4, debug: 0x2462 };

/// `Player_1`. tests: collision_port, rings_port
pub const PLAYER_1: Pin = Pin { plain: 0xFFFF89EA, debug: 0xFFFF8A0E };

/// `Dynamic_Slots`. tests: collision_port
pub const DYNAMIC_SLOTS: Pin = Pin { plain: 0xFFFF8A8A, debug: 0xFFFF8AAE };
...
pub const CAMERA_X: Pin = Pin { plain: 0xFFFFA118, debug: 0xFFFFA13C };

/// `Camera_Y`. tests: rings_port, section_port, camera_port, bg_anim_port
pub const CAMERA_Y: Pin = Pin { plain: 0xFFFFA11C, debug: 0xFFFFA140 };

/// `Camera_Deadzone_Base`. tests: camera_port
pub const CAMERA_DEADZONE_BASE: Pin = Pin { plain: 0xFFFFA82A, debug: 0xFFFFA84E };

/// `Camera_Pan_Offset`. tests: camera_port
pub const CAMERA_PAN_OFFSET: Pin = Pin { plain: 0xFFFFA82E, debug: 0xFFFFA852 };
...
pub const CAMERA_X_MAX: Pin = Pin { plain: 0xFFFFA830, debug: 0xFFFFA854 };

/// `Camera_Y_Max`. tests: camera_port
pub const CAMERA_Y_MAX: Pin = Pin { plain: 0xFFFFA832, debug: 0xFFFFA856 };

/// `BgAnim_LastStep`. tests: bg_anim_port
pub const BG_ANIM_LAST_STEP: Pin = Pin { plain: 0xFFFF8980, debug: 0xFFFF8980 };
...
pub const CAMERA_X_BIASED: Pin = Pin { plain: 0xFFFFA120, debug: 0xFFFFA144 };

/// `Camera_Y_Biased`. tests: sprites_port
pub const CAMERA_Y_BIASED: Pin = Pin { plain: 0xFFFFA122, debug: 0xFFFFA146 };

/// `Collected_MarkRing`. tests: rings_port
pub const COLLECTED_MARK_RING: Pin = Pin { plain: 0x3528, debug: 0x3CEA };

/// `EntityWindow_EntryForSection`. tests: rings_port
pub const ENTITY_WINDOW_ENTRY_FOR_SECTION: Pin = Pin { plain: 0x3744, debug: 0x41CC };

/// `EntityLoaded_Clear`. tests: rings_port
pub const ENTITY_LOADED_CLEAR: Pin = Pin { plain: 0x3730, debug: 0x4156 };

/// `Sound_PlayRing`. tests: rings_port
pub const SOUND_PLAY_RING: Pin = Pin { plain: 0x650A, debug: 0x81E6 };
...
pub const DMA_CRITICAL: Pin = Pin { plain: 0xFFFF8038, debug: 0xFFFF8038 };

/// `DMA_Critical_End`. tests: dma_queue_port
pub const DMA_CRITICAL_END: Pin = Pin { plain: 0xFFFF80A8, debug: 0xFFFF80A8 };

/// `DMA_Important`. tests: dma_queue_port
pub const DMA_IMPORTANT: Pin = Pin { plain: 0xFFFF80A8, debug: 0xFFFF80A8 };

/// `DMA_Important_End`. tests: dma_queue_port
pub const DMA_IMPORTANT_END: Pin = Pin { plain: 0xFFFF8150, debug: 0xFFFF8150 };

/// `DMA_Deferrable`. tests: dma_queue_port
pub const DMA_DEFERRABLE: Pin = Pin { plain: 0xFFFF8150, debug: 0xFFFF8150 };

/// `DMA_Deferrable_End`. tests: dma_queue_port
pub const DMA_DEFERRABLE_END: Pin = Pin { plain: 0xFFFF81F8, debug: 0xFFFF81F8 };

/// `DMA_Critical_Slot`. tests: dma_queue_port
pub const DMA_CRITICAL_SLOT: Pin = Pin { plain: 0xFFFF81F8, debug: 0xFFFF81F8 };

/// `DMA_Important_Slot`. tests: dma_queue_port
pub const DMA_IMPORTANT_SLOT: Pin = Pin { plain: 0xFFFF81FA, debug: 0xFFFF81FA };

/// `DMA_Deferrable_Slot`. tests: dma_queue_port
pub const DMA_DEFERRABLE_SLOT: Pin = Pin { plain: 0xFFFF81FC, debug: 0xFFFF81FC };

/// `DMA_Budget_Remaining`. tests: dma_queue_port
pub const DMA_BUDGET_REMAINING: Pin = Pin { plain: 0xFFFF8200, debug: 0xFFFF8200 };

/// `DMA_Overflow_Count` — debug-shape consumer only (`debug_only`). tests: dma_queue_port
pub const DMA_OVERFLOW_COUNT: u32 = 0xFFFF89F2;
...
pub const S4_LZ_DECOMPRESS: Pin = Pin { plain: 0x23D8, debug: 0x24BA };

/// `ZX0_Decompress`. tests: load_art_port
pub const ZX0_DECOMPRESS: Pin = Pin { plain: 0x24CC, debug: 0x2662 };
...
pub const BG_INIT: Pin = Pin { plain: 0x61FE, debug: 0x6FF0 };
...
pub const OBJECT_RAM: Pin = Pin { plain: 0xFFFF89EA, debug: 0xFFFF8A0E };

/// `System_Slots`. tests: core_port
pub const SYSTEM_SLOTS: Pin = Pin { plain: 0xFFFF970A, debug: 0xFFFF972E };

/// `Effect_Slots`. tests: core_port
pub const EFFECT_SLOTS: Pin = Pin { plain: 0xFFFF998A, debug: 0xFFFF99AE };

/// `Game_Paused`. tests: core_port
pub const GAME_PAUSED: Pin = Pin { plain: 0xFFFFA124, debug: 0xFFFFA148 };

/// `Object_RAM_End`. tests: core_port
pub const OBJECT_RAM_END: Pin = Pin { plain: 0xFFFF9E8A, debug: 0xFFFF9EAE };

/// `Dynamic_Free_Stack`. tests: core_port
pub const DYNAMIC_FREE_STACK: Pin = Pin { plain: 0xFFFF9E8A, debug: 0xFFFF9EAE };

/// `Dynamic_Free_SP`. tests: core_port
pub const DYNAMIC_FREE_SP: Pin = Pin { plain: 0xFFFF9EDA, debug: 0xFFFF9EFE };

/// `Effect_Free_Stack`. tests: core_port
pub const EFFECT_FREE_STACK: Pin = Pin { plain: 0xFFFF9EDC, debug: 0xFFFF9F00 };

/// `Effect_Free_SP`. tests: core_port
pub const EFFECT_FREE_SP: Pin = Pin { plain: 0xFFFF9EFC, debug: 0xFFFF9F20 };
...
pub const DELETE_OBJECT: Pin = Pin { plain: 0x2930, debug: 0x2AC6 };

/// `DrawRings`. tests: sprites_port
pub const DRAW_RINGS: Pin = Pin { plain: 0x3374, debug: 0x3AD4 };

/// `Sprite_Table_Buffer`. tests: sprites_port
pub const SPRITE_TABLE_BUFFER: Pin = Pin { plain: 0xFFFF8284, debug: 0xFFFF8284 };

/// `Sprite_Table_Dirty`. tests: sprites_port
pub const SPRITE_TABLE_DIRTY: Pin = Pin { plain: 0xFFFF8504, debug: 0xFFFF8504 };

/// `Sprite_Bands`. tests: sprites_port
pub const SPRITE_BANDS: Pin = Pin { plain: 0xFFFF9EFE, debug: 0xFFFF9F22 };

/// `Sprite_Band_Counts`. tests: sprites_port
pub const SPRITE_BAND_COUNTS: Pin = Pin { plain: 0xFFFFA0FE, debug: 0xFFFFA122 };

/// `Sprites_Rendered`. tests: sprites_port
pub const SPRITES_RENDERED: Pin = Pin { plain: 0xFFFFA106, debug: 0xFFFFA12A };

/// `Sprite_Cycle_Counter`. tests: sprites_port
pub const SPRITE_CYCLE_COUNTER: Pin = Pin { plain: 0xFFFFA108, debug: 0xFFFFA12C };

/// `SpriteMask_Y`. tests: sprites_port
pub const SPRITE_MASK_Y: Pin = Pin { plain: 0xFFFFA10A, debug: 0xFFFFA12E };

/// `SpriteMask_Height`. tests: sprites_port
pub const SPRITE_MASK_HEIGHT: Pin = Pin { plain: 0xFFFFA10C, debug: 0xFFFFA130 };

/// `SpriteMask_After_Band`. tests: sprites_port
pub const SPRITE_MASK_AFTER_BAND: Pin = Pin { plain: 0xFFFFA10E, debug: 0xFFFFA132 };

/// `Scanline_Band_Sprites`. tests: sprites_port
pub const SCANLINE_BAND_SPRITES: Pin = Pin { plain: 0xFFFFA110, debug: 0xFFFFA134 };

/// `Sound_PlaySFX`. tests: animate_port
pub const SOUND_PLAY_SFX: Pin = Pin { plain: 0x6474, debug: 0x810A };

/// `ObjectMoveX`. tests: test_g4_final_objects_port
pub const OBJECT_MOVE_X: Pin = Pin { plain: 0x2B28, debug: 0x3106 };
...
pub const DRAW_SPRITE: Pin = Pin { plain: 0x2B58, debug: 0x3136 };

/// `ObjectMove`. tests: test_objects_port
pub const OBJECT_MOVE: Pin = Pin { plain: 0x2B0E, debug: 0x30EC };
...
pub const RING_BUFFER_CLEAR: Pin = Pin { plain: 0x3366, debug: 0x3AC6 };

/// `RingBuffer_Remove`. tests: entity_window_port
pub const RING_BUFFER_REMOVE: Pin = Pin { plain: 0x3332, debug: 0x3A92 };

/// `Section_GetSecPtrXY`. tests: entity_window_port
pub const SECTION_GET_SEC_PTR_XY: Pin = Pin { plain: 0x568C, debug: 0x642C };

/// `Section_FlatIDXY`. tests: entity_window_port
pub const SECTION_FLAT_IDXY: Pin = Pin { plain: 0x5672, debug: 0x6412 };

/// `AllocDynamic`. tests: load_object_port, children_port
pub const ALLOC_DYNAMIC: Pin = Pin { plain: 0x28B2, debug: 0x2A48 };

/// `AllocEffect`. tests: children_port
pub const ALLOC_EFFECT: Pin = Pin { plain: 0x2916, debug: 0x2AAC };

/// `Palette_Buffer`. tests: buffers_port
pub const PALETTE_BUFFER: Pin = Pin { plain: 0xFFFF8202, debug: 0xFFFF8202 };

/// `Hscroll_Buffer`. tests: buffers_port
pub const HSCROLL_BUFFER: Pin = Pin { plain: 0xFFFF8506, debug: 0xFFFF8506 };

/// `Static_Pal_Line0`. tests: buffers_port
pub const STATIC_PAL_LINE0: Pin = Pin { plain: 0xFFFF8988, debug: 0xFFFF8988 };

/// `Static_Pal_Line1`. tests: buffers_port
pub const STATIC_PAL_LINE1: Pin = Pin { plain: 0xFFFF8996, debug: 0xFFFF8996 };

/// `Static_Pal_Line2`. tests: buffers_port
pub const STATIC_PAL_LINE2: Pin = Pin { plain: 0xFFFF89A4, debug: 0xFFFF89A4 };

/// `Static_Pal_Line3`. tests: buffers_port
pub const STATIC_PAL_LINE3: Pin = Pin { plain: 0xFFFF89B2, debug: 0xFFFF89B2 };

/// `Static_Sprite_DMA`. tests: buffers_port
pub const STATIC_SPRITE_DMA: Pin = Pin { plain: 0xFFFF89C0, debug: 0xFFFF89C0 };

/// `Static_Hscroll_Cell`. tests: buffers_port
pub const STATIC_HSCROLL_CELL: Pin = Pin { plain: 0xFFFF89CE, debug: 0xFFFF89CE };

/// `Static_Hscroll_Line`. tests: buffers_port
pub const STATIC_HSCROLL_LINE: Pin = Pin { plain: 0xFFFF89DC, debug: 0xFFFF89DC };

/// `Palette_Dirty`. tests: buffers_port
pub const PALETTE_DIRTY: Pin = Pin { plain: 0xFFFF8282, debug: 0xFFFF8282 };

/// `Parallax_Active_Config`. tests: buffers_port
pub const PARALLAX_ACTIVE_CONFIG: Pin = Pin { plain: 0x5CB8, debug: 0x6A58 };

/// `VBlank_Ready`. tests: vblank_port
pub const V_BLANK_READY: Pin = Pin { plain: 0xFFFF8036, debug: 0xFFFF8036 };

/// `VBlank_Flag`. tests: vblank_port
pub const V_BLANK_FLAG: Pin = Pin { plain: 0xFFFF8000, debug: 0xFFFF8000 };

/// `VInt_Ptr`. tests: vblank_port
pub const V_INT_PTR: Pin = Pin { plain: 0xFFFF8032, debug: 0xFFFF8032 };
...
pub const DMA_BUDGET_DEFAULT: Pin = Pin { plain: 0xFFFF81FE, debug: 0xFFFF81FE };

/// `Lag_Frame_Count` — debug-shape consumer only (`debug_only`). tests: vblank_port
pub const LAG_FRAME_COUNT: u32 = 0xFFFF89F4;

/// `DMA_Bytes_ThisFrame` — debug-shape consumer only (`debug_only`). tests: vblank_port
pub const DMA_BYTES_THIS_FRAME: u32 = 0xFFFF89EA;
...
pub const V_INT_DRAW_LEVEL: Pin = Pin { plain: 0x4384, debug: 0x5064 };

/// `Vscroll_Write`. tests: vblank_port
pub const VSCROLL_WRITE: Pin = Pin { plain: 0x5CCA, debug: 0x6A6A };

/// `Read_Controllers`. tests: vblank_port
pub const READ_CONTROLLERS: Pin = Pin { plain: 0x234C, debug: 0x23D8 };
...
pub const SOUND_INIT: Pin = Pin { plain: 0x6374, debug: 0x7EA6 };
...
pub const PLAYER_SENSOR_FLOOR: Pin = Pin { plain: 0x54AC, debug: 0x624C };

/// `Player_AtLedgeEdge`. tests: test_p1_player_port
pub const PLAYER_AT_LEDGE_EDGE: Pin = Pin { plain: 0x55C6, debug: 0x6366 };
...
pub const PLAYER_SENSOR_CEILING: Pin = Pin { plain: 0x54C2, debug: 0x6262 };

/// `Player_SensorWallDir`. tests: test_p2_player_states_port
pub const PLAYER_SENSOR_WALL_DIR: Pin = Pin { plain: 0x557C, debug: 0x631C };

/// `Player_SensorWallAt`. tests: test_p2_player_states_port
pub const PLAYER_SENSOR_WALL_AT: Pin = Pin { plain: 0x5574, debug: 0x6314 };

/// `Collision_GetType`. tests: test_p4_player_sensors_port
pub const COLLISION_GET_TYPE: Pin = Pin { plain: 0x50D0, debug: 0x5E70 };
