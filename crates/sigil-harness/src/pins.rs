...
pub const RASTER: Region = Region { plain_base: 0x68B0, debug_base: 0x79D4, plain_len: 0x360, debug_len: 0x360 };

/// `Palette_LoadPal` .. `Effects_InstallPreset` — gate `SIGIL_EMP_PALETTE`. tests: palette_port
pub const PALETTE: Region = Region { plain_base: 0x6C10, debug_base: 0x7D34, plain_len: 0x484, debug_len: 0x484 };

/// `Effects_InstallPreset` .. `Level_LoadArt`.
pub const PRESET: Region = Region { plain_base: 0x7094, debug_base: 0x81B8, plain_len: 0xAC, debug_len: 0xA8 };
...
pub const PAGE_CACHE: Region = Region { plain_base: 0x74BC, debug_base: 0x874C, plain_len: 0x474, debug_len: 0xB74 };

/// `BG_Init` .. `BgAnim_Init` — gate `SIGIL_EMP_BG`. tests: bg_port
pub const BG: Region = Region { plain_base: 0x7930, debug_base: 0x92C0, plain_len: 0xE0, debug_len: 0x140 };

/// `BgAnim_Init` .. start + 0x9E plain / 0x158 debug (literal — no end symbol) — gate `SIGIL_EMP_BG_ANIM`. tests: bg_anim_port
pub const BG_ANIM: Region = Region { plain_base: 0x7A10, debug_base: 0x9400, plain_len: 0x9E, debug_len: 0x158 };
...
pub const COMPRESSION_SELFTEST: Region = Region { plain_base: 0x7AAE, debug_base: 0x9558, plain_len: 0x0, debug_len: 0xDE8 };

/// `Sound_PostByte` .. start + 0x2A8 plain / 0x452 debug (literal — no end symbol) — gate `SIGIL_EMP_SOUND_API`. tests: sound_api_port
pub const SOUND_API: Region = Region { plain_base: 0x7AAE, debug_base: 0xA340, plain_len: 0x2A8, debug_len: 0x452 };
...
pub const EFFECTS_INSTALL_PRESET: Pin = Pin { plain: 0x7094, debug: 0x81B8 };

/// `Raster_GetChannelBand`. tests: parallax_port
pub const RASTER_GET_CHANNEL_BAND: Pin = Pin { plain: 0x6BB4, debug: 0x7CD8 };
...
pub const SOUND_DRAIN_SFX_RING: Pin = Pin { plain: 0x7C1A, debug: 0xA656 };
...
pub const SOUND_PLAY_RING: Pin = Pin { plain: 0x7C6A, debug: 0xA6A6 };
...
pub const BG_INIT: Pin = Pin { plain: 0x7930, debug: 0x92C0 };
...
pub const SOUND_PLAY_SFX: Pin = Pin { plain: 0x7BD4, debug: 0xA5CA };
...
pub const PAGE_CACHE_AUDIT: Pin = Pin { plain: 0x7922, debug: 0x8F18 };
...
pub const SOUND_INIT: Pin = Pin { plain: 0x7AD4, debug: 0xA366 };
...
pub const PALETTE_COMPOSE: Pin = Pin { plain: 0x6CC4, debug: 0x7DE8 };
