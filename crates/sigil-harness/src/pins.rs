...
//!
//! [provenance] plain: /home/volence/sonic_hacks/aeon-t18/s4.lst (07/23/2026 04:03:54 PM)
//! [provenance] debug: /home/volence/sonic_hacks/aeon-t18/s4.debug.lst (07/23/2026 04:03:56 PM)
...
pub const PARALLAX: Region = Region { plain_base: 0x5B38, debug_base: 0x67C2, plain_len: 0x532, debug_len: 0x532 };

/// `Sound_PostByte` .. start + 0x20A plain / 0x3B4 debug (literal — no end symbol) — gate `SIGIL_EMP_SOUND_API`. tests: sound_api_port
pub const SOUND_API: Region = Region { plain_base: 0x6220, debug_base: 0x7B8E, plain_len: 0x20A, debug_len: 0x3B4 };
...
pub const SOUND_DRAIN_SFX_RING: Pin = Pin { plain: 0x638C, debug: 0x7EA4 };
...
pub const SOUND_PLAY_RING: Pin = Pin { plain: 0x63DC, debug: 0x7EF4 };
...
pub const SOUND_PLAY_SFX: Pin = Pin { plain: 0x6346, debug: 0x7E18 };
