...
//!
//! [provenance] plain: /home/volence/sonic_hacks/aeon-t18/s4.lst (07/23/2026 03:27:46 PM)
//! [provenance] debug: /home/volence/sonic_hacks/aeon-t18/s4.debug.lst (07/23/2026 03:27:47 PM)
...
pub const PARALLAX: Region = Region { plain_base: 0x5B02, debug_base: 0x678C, plain_len: 0x532, debug_len: 0x532 };

/// `Sound_PostByte` .. start + 0x20A plain / 0x3B4 debug (literal — no end symbol) — gate `SIGIL_EMP_SOUND_API`. tests: sound_api_port
pub const SOUND_API: Region = Region { plain_base: 0x61EA, debug_base: 0x7B58, plain_len: 0x20A, debug_len: 0x3B4 };
...
pub const SOUND_DRAIN_SFX_RING: Pin = Pin { plain: 0x6356, debug: 0x7E6E };
...
pub const SOUND_PLAY_RING: Pin = Pin { plain: 0x63A6, debug: 0x7EBE };
...
pub const SOUND_PLAY_SFX: Pin = Pin { plain: 0x6310, debug: 0x7DE2 };
