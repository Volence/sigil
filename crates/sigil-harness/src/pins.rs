...
pub const PAGE_CACHE: Region = Region { plain_base: 0x66F6, debug_base: 0x764A, plain_len: 0x2FA, debug_len: 0x766 };

/// `BG_Init` .. `BgAnim_Init` — gate `SIGIL_EMP_BG`. tests: bg_port
pub const BG: Region = Region { plain_base: 0x69F0, debug_base: 0x7DB0, plain_len: 0xE0, debug_len: 0xE0 };

/// `BgAnim_Init` .. start + 0x9E plain / 0x158 debug (literal — no end symbol) — gate `SIGIL_EMP_BG_ANIM`. tests: bg_anim_port
pub const BG_ANIM: Region = Region { plain_base: 0x6AD0, debug_base: 0x7E90, plain_len: 0x9E, debug_len: 0x158 };
...
pub const COMPRESSION_SELFTEST: Region = Region { plain_base: 0x6B6E, debug_base: 0x7FE8, plain_len: 0x0, debug_len: 0xD88 };

/// `Sound_PostByte` .. start + 0x20A plain / 0x3B4 debug (literal — no end symbol) — gate `SIGIL_EMP_SOUND_API`. tests: sound_api_port
pub const SOUND_API: Region = Region { plain_base: 0x6B6E, debug_base: 0x8D70, plain_len: 0x20A, debug_len: 0x3B4 };
...
pub const SOUND_DRAIN_SFX_RING: Pin = Pin { plain: 0x6CDA, debug: 0x9086 };
...
pub const SOUND_PLAY_RING: Pin = Pin { plain: 0x6D2A, debug: 0x90D6 };
...
pub const BG_INIT: Pin = Pin { plain: 0x69F0, debug: 0x7DB0 };
...
pub const SOUND_PLAY_SFX: Pin = Pin { plain: 0x6C94, debug: 0x8FFA };
...
pub const SOUND_INIT: Pin = Pin { plain: 0x6B94, debug: 0x8D96 };
