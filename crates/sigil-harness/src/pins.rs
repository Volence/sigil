...
//!
//! [provenance] plain: /home/volence/sonic_hacks/aeon/s4.lst (07/12/2026 01:28:22 PM)
//! [provenance] debug: /home/volence/sonic_hacks/aeon/s4.debug.lst (07/12/2026 01:28:20 PM)
...
pub const COLLISION: Region = Region { plain_base: 0x2FC2, debug_base: 0x3278, plain_len: 0x166, debug_len: 0x166 };

/// `RingBuffer_Add` .. `Collected_Init` — gate `SIGIL_EMP_RINGS`. tests: rings_port
pub const RINGS: Region = Region { plain_base: 0x3128, debug_base: 0x33DE, plain_len: 0x1BE, debug_len: 0x21A };

/// `Collision_GetType` .. `Collision_ProbeDown` — gate `SIGIL_EMP_COLLISION_LOOKUP`. tests: collision_lookup_port
pub const COLLISION_LOOKUP: Region = Region { plain_base: 0x4B38, debug_base: 0x5358, plain_len: 0x24, debug_len: 0x24 };

/// `Sound_PostByte` .. start + 0x1E4 (no end symbol in the listing) — gate `SIGIL_EMP_SOUND_API`. tests: sound_api_port
pub const SOUND_API: Region = Region { plain_base: 0x5CAE, debug_base: 0x7168, plain_len: 0x1E4, debug_len: 0x1E4 };
...
pub const SOUND_DRAIN_SFX_RING: Pin = Pin { plain: 0x5DF4, debug: 0x72AE };
...
pub const TILE_CACHE_GET_COLLISION: Pin = Pin { plain: 0x4250, debug: 0x49B8 };
...
pub const COLLECTED_MARK_RING: Pin = Pin { plain: 0x336A, debug: 0x36DE };

/// `EntityWindow_EntryForSection`. tests: rings_port
pub const ENTITY_WINDOW_ENTRY_FOR_SECTION: Pin = Pin { plain: 0x358E, debug: 0x3BC0 };

/// `EntityLoaded_Clear`. tests: rings_port
pub const ENTITY_LOADED_CLEAR: Pin = Pin { plain: 0x357A, debug: 0x3B4A };

/// `Sound_PlayRing`. tests: rings_port
pub const SOUND_PLAY_RING: Pin = Pin { plain: 0x5E44, debug: 0x72FE };
...
pub const DRAW_RINGS: Pin = Pin { plain: 0x31AE, debug: 0x34C0 };
...
pub const SOUND_PLAY_SFX: Pin = Pin { plain: 0x5DAE, debug: 0x7268 };
