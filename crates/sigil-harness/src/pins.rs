...
//!
//! [provenance] plain: /home/volence/sonic_hacks/aeon/.worktrees/port-tranche19/s4.lst (07/24/2026 02:11:02 AM)
//! [provenance] debug: /home/volence/sonic_hacks/aeon/.worktrees/port-tranche19/s4.debug.lst (07/24/2026 02:11:01 AM)
...
/// `BgAnim_Init` .. start + 0x9E plain / 0x100 debug (literal — no end symbol) — gate `SIGIL_EMP_BG_ANIM`. tests: bg_anim_port
pub const BG_ANIM: Region = Region { plain_base: 0x61BE, debug_base: 0x6E92, plain_len: 0x9E, debug_len: 0x100 };

/// `Sound_PostByte` .. start + 0x20A plain / 0x3B4 debug (literal — no end symbol) — gate `SIGIL_EMP_SOUND_API`. tests: sound_api_port
pub const SOUND_API: Region = Region { plain_base: 0x625C, debug_base: 0x7C2C, plain_len: 0x20A, debug_len: 0x3B4 };
...
pub const SOUND_DRAIN_SFX_RING: Pin = Pin { plain: 0x63C8, debug: 0x7F42 };
...
pub const SOUND_PLAY_RING: Pin = Pin { plain: 0x6418, debug: 0x7F92 };
...
pub const SOUND_PLAY_SFX: Pin = Pin { plain: 0x6382, debug: 0x7EB6 };
