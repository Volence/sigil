...
//!
//! [provenance] plain: /home/volence/sonic_hacks/aeon/s4.lst (07/13/2026 10:27:20 AM)
//! [provenance] debug: /home/volence/sonic_hacks/aeon/s4.debug.lst (07/13/2026 10:27:19 AM)
...
pub const LOAD_OBJECT: Region = Region { plain_base: 0x3FDC, debug_base: 0x4BA6, plain_len: 0x98, debug_len: 0x98 };

/// `Collision_GetType` .. `Collision_ProbeDown` — gate `SIGIL_EMP_COLLISION_LOOKUP`. tests: collision_lookup_port
pub const COLLISION_LOOKUP: Region = Region { plain_base: 0x4C34, debug_base: 0x58B6, plain_len: 0x24, debug_len: 0x24 };

/// `Sound_PostByte` .. start + 0x1E4 plain / 0x2DA debug (literal — no end symbol) — gate `SIGIL_EMP_SOUND_API`. tests: sound_api_port
pub const SOUND_API: Region = Region { plain_base: 0x5DAA, debug_base: 0x76C6, plain_len: 0x1E4, debug_len: 0x2DA };
...
pub const SOUND_DRAIN_SFX_RING: Pin = Pin { plain: 0x5EF0, debug: 0x7902 };
...
pub const TILE_CACHE_GET_COLLISION: Pin = Pin { plain: 0x434C, debug: 0x4F16 };
...
pub const SOUND_PLAY_RING: Pin = Pin { plain: 0x5F40, debug: 0x7952 };
...
pub const SOUND_PLAY_SFX: Pin = Pin { plain: 0x5EAA, debug: 0x7876 };
...
pub const SECTION_GET_SEC_PTR_XY: Pin = Pin { plain: 0x51A6, debug: 0x5E28 };

/// `Section_FlatIDXY`. tests: entity_window_port
pub const SECTION_FLAT_IDXY: Pin = Pin { plain: 0x518C, debug: 0x5E0E };
