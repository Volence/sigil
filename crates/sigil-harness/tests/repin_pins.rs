...
fn generated_pins_match_the_hand_typed_baseline() {
    ...
    assert_eq!(pins::ANIMATE.plain_base, 0x2E06);
    assert_eq!(pins::ANIMATE.debug_base, 0x30BC);
    ...
    assert_eq!(pins::RINGS.plain_base, 0x30FE);
    assert_eq!(pins::RINGS.debug_base, 0x33B4);
    ...
    assert_eq!(pins::CORE.plain_len, 0x252);
    assert_eq!(pins::CORE.debug_base, 0x2926);
    assert_eq!(pins::CORE.debug_len, 0x376);
...
fn secondary_pin_classes_match_the_hand_typed_baseline() {
    ...
    // in-block.
    assert_eq!(pins::SOUND_API.plain_base, 0x5C84);
    assert_eq!(pins::SOUND_API.debug_base, 0x713E);
