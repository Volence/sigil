...
fn generated_pins_match_the_hand_typed_baseline() {
    ...
    assert_eq!(pins::PARALLAX_CONFIGS.plain_len, 0xACE);  // +0x44 parcel-w: ParallaxConfig_OJZ_Underwater, the anchored fixture. EXACTLY sizeof(parallax_config) 28 + 4 bands x 10 = 68 = 0x44, and shape-invariant because it is data.
    assert_eq!(pins::PARALLAX_CONFIGS.debug_len, 0xACE);  // +0x44 parcel-w: same record, same size in both shapes.
